    ...
    return (
      <div className="min-h-screen bg-[#fafaf8] flex items-center justify-center p-8">
        <div className="text-center space-y-4 max-w-sm">
          <div className="w-14 h-14 rounded-full bg-[#f0f7f2] flex items-center justify-center mx-auto">
            <CheckCircle className="w-7 h-7 text-[#0f6b3a]" />
          </div>
          <h2 className="text-2xl font-bold tracking-tight text-[#111113]">Conta criada!</h2>
          <p className="text-zinc-400">
            Enviamos um link de confirmacao para <strong className="text-[#111113]">{email}</strong>.
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-gradient-to-br from-[#0d5c30] via-[#0f6b3a] to-[#072918] flex-col justify-between p-12 text-white">
        ...
        <div className="space-y-6">
          <h1 className="text-4xl font-bold leading-tight tracking-tight">
            Comece em<br />5 minutos.
          </h1>
          <div className="space-y-3 text-white/55 text-[15px]">
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-[11px] font-semibold text-white/70">1</div>
              <span>Crie sua conta</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-[11px] font-semibold text-white/70">2</div>
              <span>Configure seu negocio e bot</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-[11px] font-semibold text-white/70">3</div>
              <span>Conecte seu WhatsApp</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-[11px] font-semibold text-white/70">4</div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#fafaf8]">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-[#111113]">Criar conta</h2>
            <p className="text-zinc-400 mt-1 text-[15px]">7 dias gratis. Sem cartao.</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-[13px] font-medium text-zinc-600">Seu nome</label>
              <input
                type="text"
                value={name}
